...
- [The slides](https://stilianoudakis.github.io/slides_preciseTADworkshop/#1)

- [Github repo](https://github.com/dozmorovlab/preciseTADworkshop)

- [Docker image](https://hub.docker.com/repository/docker/stilianoudakis/precisetadworkshop)

- [Pkgdown website](https://dozmorovlab.github.io/preciseTADworkshop/)
